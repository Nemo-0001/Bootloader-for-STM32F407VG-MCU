...
/* ----------------- Global Variables Definitions start -----------------*/
...
/* ----------------- Global Variables Definitions end -----------------*/
...
/* -----------------  SW Interfaces Definitions start -----------------*/
		...
		if(HAL_Status != HAL_OK){
			...
			switch(BL_Host_Buffer[1]){
				...
				case CBL_ED_W_PROTECT_CMD:
					BL_Print_Message("Enable or Disable write protection on different sectors of the user flash \r\n");
				...
				case CBL_CHANGE_ROP_Level_CMD:
					...
					break;
				default:
					BL_Print_Message("Invalid command code !! \r\n");
					break;
			}
		}
	}
...
//A variadic function to send unknown length of data over UART
